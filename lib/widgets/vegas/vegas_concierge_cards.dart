...
/// Horizontal mood route picker — Las Vegas pack only.
class VegasMoodRoutesPanel extends StatelessWidget {
  const VegasMoodRoutesPanel({
    super.key,
    this.onRouteSelected,
  });

  final void Function(VegasMoodRoute route)? onRouteSelected;

  @override
  Widget build(BuildContext context) {
    final tokens = luxThemeTokensOf(context);
    final routes = VegasMoodRouteService.routesForActive();
