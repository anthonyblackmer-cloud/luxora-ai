...
/// Horizontal mood route picker — St. Augustine pack only.
class StAugustineMoodRoutesPanel extends StatelessWidget {
  const StAugustineMoodRoutesPanel({
    super.key,
    this.onRouteSelected,
  });

  final void Function(StAugustineMoodRoute route)? onRouteSelected;

  @override
  Widget build(BuildContext context) {
    final l = context.l10n;
    final tokens = luxThemeTokensOf(context);
    final routes = StAugustineMoodRouteService.routesForActive();
