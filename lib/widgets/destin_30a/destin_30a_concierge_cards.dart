...
/// Horizontal mood route picker — Destin & 30A pack only.
class Destin30aMoodRoutesPanel extends StatelessWidget {
  const Destin30aMoodRoutesPanel({
    super.key,
    this.onRouteSelected,
  });

  final void Function(Destin30aMoodRoute route)? onRouteSelected;

  @override
  Widget build(BuildContext context) {
    final l = context.l10n;
    final tokens = luxThemeTokensOf(context);
    final routes = Destin30aMoodRouteService.routesForActive();
