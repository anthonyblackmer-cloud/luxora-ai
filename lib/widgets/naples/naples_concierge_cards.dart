...
/// Horizontal mood route picker — Naples pack only.
class NaplesMoodRoutesPanel extends StatelessWidget {
  const NaplesMoodRoutesPanel({
    super.key,
    this.onRouteSelected,
  });

  final void Function(NaplesMoodRoute route)? onRouteSelected;

  @override
  Widget build(BuildContext context) {
    final l = context.l10n;
    final tokens = luxThemeTokensOf(context);
    final routes = NaplesMoodRouteService.routesForActive();
