...
/// Horizontal mood route picker — New York City pack only.
class NycMoodRoutesPanel extends StatelessWidget {
  const NycMoodRoutesPanel({
    super.key,
    this.onRouteSelected,
  });

  final void Function(NycMoodRoute route)? onRouteSelected;

  @override
  Widget build(BuildContext context) {
    final l = context.l10n;
    final tokens = luxThemeTokensOf(context);
    final routes = NycMoodRouteService.routesForActive();
