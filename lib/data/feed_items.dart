...
const discoveryFeed = [
  FeedItem(
    ...
    title: 'Luma on Park — golden hour',
    subtitle: 'Winter Park · Park Avenue favorite',
    location: 'Orlando metro',
    headline:
        'Seasonal American on Park Avenue — reservations fill fast for sunset-adjacent tables.',
  ...
  FeedItem(
    ...
    title: 'Magic Kingdom after dark',
  ...
  FeedItem(
    ...
    title: 'Woodhouse Day Spa — Winter Park',
    subtitle: 'Park Avenue corridor',
    location: 'Winter Park, FL',
    headline:
        'Massage, facials, and quiet rooms minutes from Park Avenue — easy first-day reset.',
    socialProof: 'Book ahead · weekend slots fill',
    gradient: [Color(0xFFA78BFA), Color(0xFF6366F1), Color(0xFF1E293B)],
  ),
  FeedItem(
    id: 'feed-creator-keys',
    kind: FeedItemKind.creatorPick,
    title: 'Cocoa Beach pier sunset',
    subtitle: '@floridaluxlife pick',
    location: 'Space Coast',
    headline:
        'Creator-favorite post-park beach reset — pier tacos, Atlantic breeze, and a slower evening pace.',
  ...
  FeedItem(
    ...
    title: 'Kelly Park tube run',
    subtitle: 'Beat the heat · Rock Springs',
    location: 'Apopka, FL',
    headline:
        'Seasonal favorite: morning tube run at Kelly Park, then shaded lunch — built for July humidity.',
  ...
  FeedItem(
    ...
    title: 'Clearwater Beach — evening light',
    subtitle: 'Gulf coast · sunset window',
    location: 'Clearwater, FL',
    headline:
        'Live: west-facing sand clearing — best pier light expected 6:15–7:00 PM. Pier 60 festival Saturdays.',
